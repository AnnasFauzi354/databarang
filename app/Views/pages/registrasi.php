        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                  ...
                  <form action="<?= base_url('/registrasi/process') ?>" method="post" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="konfirmasipassword"
                        class="form-control <?= (session('validation') && session('validation')->hasError('konfirmasipassword')) ? 'is-invalid' : '' ?>"
                        id="konfirmasipassword"
                        value="<?= old('konfirmasipassword') ?>"
                        id="konfirmasipassword" required>
                      <?php if (session('validation') && session('validation')->hasError('konfirmasipassword')) : ?>
                        <div class="invalid-feedback">
                          <?= session('validation')->getError('konfirmasipassword') ?>
                        </div>
                      <?php endif; ?>
                    </div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Sudah Punya Akun ? <a href="/pages/login">Login</a></p>
                    </div>
                  </form>
              ...
              <div class="credits">
                Designed by <a href="https://bootstrapmade.com/">Diskominfo</a>
              </div>
